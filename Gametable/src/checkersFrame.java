...
public class checkersFrame {
	...
	private static void checkers() throws IOException {
        ...
        BufferedImage CheckersIco = ImageIO.read(new File("Images/checkers.png"));
        Image checkersImage = CheckersIco.getScaledInstance(1200, 1200, Image.SCALE_SMOOTH);
        ImageIcon checkersI = new ImageIcon(checkersImage);

        //Game mat 
        JButton checkMat = new JButton(checkersI);
		...
		checkers.add(background);
		checkers.setExtendedState(JFrame.MAXIMIZED_BOTH);
		checkers.setUndecorated(true);
